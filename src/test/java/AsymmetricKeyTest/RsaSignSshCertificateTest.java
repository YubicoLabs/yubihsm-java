...
public class RsaSignSshCertificateTest {
    Logger log = Logger.getLogger(RsaSignSshCertificateTest.class.getName());
    ...
    public void testSSHCertificateSign() throws Exception {
        ...
        try {
            ...
            try {
                YHObject.deleteObject(session, keyId, AsymmetricKey.TYPE);
            ...
            try {
                YHObject.deleteObject(session, templateId, Template.TYPE);
            } catch (YHDeviceException e) {
                if (!e.getYhError().equals(YHError.OBJECT_NOT_FOUND)) {
                    throw e;
                }
