...
public enum Capability {
    ...
    /** Read Opaque Objects */
    GET_OPAQUE(0x0000000000000001L, "get-opaque", "Read Opaque Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    /** Import Opaque Objects */
    PUT_OPAQUE(0x0000000000000002L, "put-opaque", "Write Opaque Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    /** Import Authentication Key Objects */
    PUT_AUTHENTICATION_KEY((long) 0x0000000000000004L, "put-authentication-key", "Write Authentication Key Objects",
                           new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    ...
    SIGN_PKCS(0x0000000000000020L, "sign-pkcs", "Compute signatures using RSA-PKCS1v1.5",
              new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_ASYMMETRIC_KEY))),
    ...
    EXPORT_WRAPPED(0x0000000000001000L, "export-wrapped", "Export other Objects under wrap",
                   new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_WRAP_KEY))),
    /** Import wrapped Objects */
    IMPORT_WRAPPED(0x0000000000002000L, "import-wrapped", "Import wrapped Objects",
                   new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_WRAP_KEY))),
    /** Import Wrap Key Objects */
    PUT_WRAP_KEY(0x0000000000004000L, "put-wrap-key", "Write Wrap Key Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    ...
    EXPORTABLE_UNDER_WRAP(0x0000000000010000L, "exportable-under-wrap", "Mark an Object as exportable under wrap", new ArrayList<>(
            Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_WRAP_KEY, Type.TYPE_ASYMMETRIC_KEY,
                          Type.TYPE_HMAC_KEY, Type.TYPE_OPAQUE, Type.TYPE_OTP_AEAD_KEY,
                          Type.TYPE_TEMPLATE))),
    /** Write device-global options */
    SET_OPTION(0x0000000000020000L, "set-option", "Write device-global options", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    /** Read device-global options */
    GET_OPTION(0x0000000000040000L, "get-option", "Read device-global options", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    /** Extract random bytes */
    GET_PSEUDO_RANDOM(0x0000000000080000L, "get-pseudo-random", "Extract random bytes",
                      new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    /** Import HMAC Key Objects */
    PUT_HMAC_KEY(0x0000000000100000L, "put-mac-key", "Write HMAC Key Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    ...
    SIGN_HMAC(0x0000000000400000L, "sign-hmac", "Compute HMAC of data",
              new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_HMAC_KEY))),
    /** Verify HMAC of data */
    VERIFY_HMAC(0x0000000000800000L, "verify-hmac", "Verify HMAC of data",
                new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_HMAC_KEY))),
    /** Read the Log Store */
    GET_LOG_ENTRIES(0x0000000001000000L, "get-log-entries", "Read the Log Store", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    ...
    GET_TEMPLATE(0x0000000004000000L, "get-template", "Read Template Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    /** Import Template Objects */
    PUT_TEMPLATE(0x0000000008000000L, "put-template", "Write Template Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
    ...
    DECRYPT_OTP(0x0000000020000000L, "decrypt-otp", "Decrypt OTP",
                new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY, Type.TYPE_OTP_AEAD_KEY))),
    /** Create OTP AEAD */
    ...
    DELETE_OPAQUE(0x0000008000000000L, "delete-opaque", "Delete Opaque Objects", new ArrayList<>(Arrays.asList(Type.TYPE_AUTHENTICATION_KEY))),
